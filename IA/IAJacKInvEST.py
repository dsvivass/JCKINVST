...
x = df[['09:00:00','09:01:00','09:02:00','09:03:00','09:04:00','09:05:00','09:06:00','09:07:00','09:08:00']] # ,'09:10:00','09:15:00','09:20:00','09:25:00','09:30:00','09:35:00'
y = df[['09:15:00']]
...
#
input = [('polinomio',PolynomialFeatures(degree=gradoR)), ('regresion', Ridge(alpha=paramR))]
# parametros = [{'polinomio__degree':list(range(1,20)), 'regresion__alpha':[0.001, 0.01, 0.1, 1, 10, 100, 1000]}] # 0, 0.0001, 0.001, 0.01, 0.1, 1, 10, 100, 1000, 10000
pipe = Pipeline(steps=input)
os.chdir(DirAct)
...
for col in df.columns:
    ...
    # scores = grid.cv_results_
    # print(scores)
    Predict = pipe.predict(df_org[['09:00:00','09:01:00','09:02:00','09:03:00','09:04:00','09:05:00','09:06:00','09:07:00','09:08:00']])
